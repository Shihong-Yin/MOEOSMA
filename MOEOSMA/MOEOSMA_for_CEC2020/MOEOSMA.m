function [Archive_X,Archive_F] = MOEOSMA(func_name,lb,ub,obj_no,dim,PopSize,MaxIter)
% MOEOSMA for solving CEC2020 functions
...
Fitness = inf*ones(PopSize,obj_no);
for i = 1:PopSize
    Fitness(i,:) = feval(func_name,X(i,:));
end
